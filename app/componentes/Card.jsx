...
const Card = ({ titulo, precio, stock, imagen, _id}) => {
    const { eliminarProducto, addCarrito  } = useEcommerce()
    return (
        ...
        <div className="max-w-sm ml-5 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="p-5">
                ...
                <button onClick={()=>addCarrito(_id)} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Mi carrito
